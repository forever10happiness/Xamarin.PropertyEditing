...
namespace Xamarin.PropertyEditing.Tests
{
		...
		: PredefinedValuesViewModelTests<T>
	{
		...
		protected override PredefinedValuesViewModel<T> GetViewModel (IPropertyInfo property, IEnumerable<IObjectEditor> editors)
		{
			return new PredefinedValuesViewModel<T> (property, editors);
		}
